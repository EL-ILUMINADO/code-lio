  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-4 py-2.5 bg-[#1e1e2e]/80 rounded-lg transition-all duration-400 border border-gray-800/50 hover:border-gray-700 ${!hasAccess && language !== "javascript" ? "cursor-not-allowed opacity-50" : ""}`}
      >
        {/* decoration */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          aria-hidden="true"
        />

        <div className="w-6 h-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform duration-500">
          <Image
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors duration-400">
