const CardSkeleton = () => (
  <div className="flex flex-col gap-2 p-4 border rounded-xl bg-gray-900/50 border-gray-800 animate-pulse h-[280px]">
    <div className="flex items-center justify-between">
      <div className="h-8 w-1/3 bg-gray-800 rounded-lg" />
      <div className="h-8 w-8 bg-gray-800 rounded-lg" />
    </div>
    <div className="flex-1 bg-gray-800/50 rounded-lg mt-2" />
